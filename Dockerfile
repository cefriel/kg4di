...
# Copy Java helper
COPY camel-routes-exercises/functions/GeoFunctions.java /opt/helpers/GeoFunctions.java
...
CMD jbang --java-options="-Dhttp.agent=MyCustomAgent/1.0" \
  camel@apache/camel run \
  camel-routes/*.yaml \
  /opt/helpers/GeoFunctions.java \
