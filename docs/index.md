...
| **Break** | 30 min | |
| **Part 3 — Chimera Framework** | 30 min + [1 hour] | Architecture overview; Main Chimera concepts and related components; Chimera in action + [guided pipeline construction for the tutorial use case: ingestion, lifting, SPARQL enrichment, construction, lowering, and visualisation] |
