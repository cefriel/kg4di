...
description: "Discover how Knowledge Graphs can solve data interoperability challenges and then get hands-on with Chimera to build an interactive dashboard from heterogeneous data sources<br><strong>ESWC 2026 — Dubrovnik, Croatia</strong>"
